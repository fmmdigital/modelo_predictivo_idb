...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  2 15:05:07 2022
...
print("Preparando modelo AdaBoostClassifier ")
...
# Model
print('Estimando modelo rAdaBoost')
model = AdaBoostClassifier(**params).fit(X_proc, Y)
